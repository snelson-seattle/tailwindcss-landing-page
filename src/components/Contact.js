const Contact = () => {
  return (
    <section id="contact" className="my-12 p-6 scroll-mt-20 widescreen:section-min-height tallscreen:section-min-height">
      ...
      <form className="max-w-4xl mx-auto text-2xl sm:text-3xl flex flex-col items-left gap-4" onSubmit={(e) => e.preventDefault()}>
        ...
        <textarea name="message" id="message" cols="30" rows="10" required placeholder="Your Message" className="w-full text-black text-2xl sm:text-3xl p-3 rounded-xl border border-solid border-slate-900 dark:border-none" />
